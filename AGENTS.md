...
All project rules are defined in `.Codex/rules/` directory and loaded automatically at session start.

### 🚨 Critical Rules
- **Code Review**: `.Codex/rules/code-review-rules.md` - Mandatory review before merging
- **Security**: `.Codex/rules/security.md` - Secrets management, input validation, RLS policies
- **Database Schema**: `.Codex/rules/database-schema.md` - Migration files, type generation
- **API Architecture**: `.Codex/rules/api-architecture.md` - BaseAPI pattern, shared client
- **Documentation**: `.Codex/rules/documentation.md` - External system integration docs
- **Testing**: `.Codex/rules/testing.md` - Test requirements and standards
...
- ✅ Follow documentation template in `.Codex/rules/documentation.md`
